...
Compute the log-likelihood for a STAR model. The code here assumes that
the transformed real-valued process (z_star) has conditionally
independent components with means `mu` and standard deviations `sigma`.
